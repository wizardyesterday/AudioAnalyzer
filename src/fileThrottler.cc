...
// As an example, my signal anzlyzer reads its input from stdin.  If PCM
// data has been captured to a file at a sample rate of 32000S/s, and
// 8192 16-bit PCM samples were in each block of data, a 256ms (256000 us)
// delay would be specified.  This allows a realtime playback of the data.
// This data could be piped to my signal analyzer app for realtime playback
// of the file (as it were being streamed my NCO).
//
